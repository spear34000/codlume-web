...
function Contact() {
  ...
  const mailtoHref = useMemo(() => {
    const subject = encodeURIComponent(
      `[Codlume 문의] ${form.work || '프로젝트 검토 요청'}`,
    );
  ...
  return (
    <div className="page contactPage">
      <section className="subHero shell">
        ...
        <p>
          아이디어, 기존 서비스, 반복 업무 중 무엇이든 괜찮습니다. 필요한 기능과
          나중에 미뤄도 되는 기능을 나눠 일정과 비용 범위를 회신드립니다.
        </p>
      </section>
      ...
      <section className="contactContent shell">
        <div className="contactGrid">
          <div className="contactMethodGrid">
            ...
            <a
              className="contactMethodCard contactMethodLink"
          ...
          <div className="contactDetailsCard">
            ...
            <div className="detailContent">
              <div className="guideItem">
                ...
                <p>
                  문의 전환, 내부 업무, 앱 출시, 서버 운영 중 어떤 문제가 가장
                  급한지 알려주세요.
                </p>
              </div>
              <div className="guideItem">
                ...
                <p>
                  웹, 앱, 관리자, 자동화, 서버 이전처럼 생각 중인 형태가 있으면
                  적어주세요.
                </p>
              </div>
              <div className="guideItem">
                ...
                <p>
                  비슷한 기능을 가진 서비스나 벤치마킹하고 싶은 사례가 있다면
                  공유해주세요.
                </p>
              </div>
              <div className="guideItem">
                ...
                <p>
                  언제까지 제품이 필요한지, 혹은 고정된 예산 범위가 있는지
                  알려주시면 최적화된 제안이 가능합니다.
                </p>
              </div>
            </div>
            ...
            <div className="responseTime">
              <span>
                평균 응답 시간: <strong>24시간 이내</strong> (영업일 기준)
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="contactFormSection shell">
        <div className="contactFormCard">
          <div className="contactFormIntro">
            ...
            <p>
              아래 내용을 채우면 메일 앱에 상담 요청 초안이 열립니다. 전송 전
              내용을 직접 수정할 수 있습니다.
            </p>
          </div>
          <form
