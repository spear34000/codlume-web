      ...
      <>
        ...
        <header className="header">
          ...
          <nav aria-label="주요 메뉴">
            <NavLink className={navLinkClass} to="/web">
              <Globe size={14} /> 웹
            </NavLink>
            <span className="navDivider"></span>
            <NavLink className={navLinkClass} to="/app">
              <Smartphone size={14} /> 앱
            </NavLink>
            <span className="navDivider"></span>
            <NavLink className={navLinkClass} to="/bot">
              <BotMessageSquare size={14} /> 봇
            </NavLink>
            <span className="navDivider"></span>
            <NavLink className={navLinkClass} to="/server">
              <Cpu size={14} /> 서버
            </NavLink>
            <span className="navDivider"></span>
            <NavLink className={navLinkClass} to="/security">
              <Lock size={14} /> 보안
            </NavLink>
            <span className="navDivider"></span>
